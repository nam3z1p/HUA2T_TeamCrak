...
namespace Android_Auto_Tool
{
	partial class RootingBypass
	{
		...
		private void InitializeComponent()
		{
			...
			this.RootingBypassInstall_button = new System.Windows.Forms.Button();
			this.RootingBypassStart_Button = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// Process_View
			// 
			...
			this.cmd_view.Location = new System.Drawing.Point(330, 351);
			...
			this.cmd_view.Size = new System.Drawing.Size(341, 82);
			...
			// 
			// RootingBypassInstall_button
			// 
			this.RootingBypassInstall_button.Location = new System.Drawing.Point(330, 88);
			this.RootingBypassInstall_button.Name = "RootingBypassInstall_button";
			this.RootingBypassInstall_button.Size = new System.Drawing.Size(341, 33);
			this.RootingBypassInstall_button.TabIndex = 17;
			this.RootingBypassInstall_button.Text = "RootingBypass Install";
			this.RootingBypassInstall_button.UseVisualStyleBackColor = true;
			this.RootingBypassInstall_button.Click += new System.EventHandler(this.RootingBypassInstall_buttonClick);
			// 
			// RootingBypassStart_Button
			// 
			this.RootingBypassStart_Button.Location = new System.Drawing.Point(330, 127);
			this.RootingBypassStart_Button.Name = "RootingBypassStart_Button";
			this.RootingBypassStart_Button.Size = new System.Drawing.Size(341, 218);
			this.RootingBypassStart_Button.TabIndex = 18;
			this.RootingBypassStart_Button.Text = "RootingBypass Start";
			this.RootingBypassStart_Button.UseVisualStyleBackColor = true;
			this.RootingBypassStart_Button.Click += new System.EventHandler(this.RootingBypassStart_ButtonClick);
			// 
			// RootingBypass
			// 
			...
			this.Controls.Add(this.RootingBypassStart_Button);
			this.Controls.Add(this.RootingBypassInstall_button);
			...
			this.Name = "RootingBypass";
			this.Text = "RootingBypass";
			this.ResumeLayout(false);
			this.PerformLayout();
		}
		private System.Windows.Forms.Button RootingBypassStart_Button;
		private System.Windows.Forms.Button RootingBypassInstall_button;
